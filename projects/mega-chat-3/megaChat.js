...
export default class MegaChat {
  constructor() {
    ...
    this.ui = {
      ...
      userPhoto: new UserPhoto(
        ...
        document.querySelector('[data-role="upload"]')
      ),
    };
    ...
    function validate(e) {
      ...
      if (!regex.test(char)) {
        ...
        alert('Логин должен содержать только английские символы!');
      }
    }
    document.querySelector('.login-name-input').addEventListener('input', validate);
  ...
  onMessage({ type, from, data }) {
    ...
    document.querySelector('.chat__number').innerHTML = 'количество участников -' + document.getElementsByClassName('user-list-item').length;
    ...
    close.addEventListener('click', () =>{
      ...
      document.querySelector('[data-role="preview"]').style.backgroundImage = '';
    ...
    file.addEventListener('change', (e) => {
      ...
      reader.onload = function() {
        document.querySelector('[data-role="preview"]').style.backgroundImage = '';
        document.querySelector('[data-role="preview"]').style.backgroundImage = `url(${reader.result})`
      };
    })
